...
export const MobileHeroBg = styled.div`
  display: none;
...
export const MobileHeroOverlay = styled.div`
  display: none;
  ...
  @media (max-width: 980px) {
    ...
    background: linear-gradient(
      180deg,
      rgba(5, 30, 16, 0.48) 0%,
      rgba(5, 30, 16, 0.64) 55%,
      rgba(5, 30, 16, 0.82) 100%
    );
  }
`;

/* Wraps only the image+overlay area on mobile, excludes FilterPanel */
export const MobileHeroImageArea = styled.div`
  display: contents;
