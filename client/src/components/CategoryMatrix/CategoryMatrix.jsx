...
function CardMediaContent({ item, Icon, Scene }) {
  ...
  return (
    <Media $mobileAuction={item.title === "Auctions"}>
      {showImage ? (
        <MediaImage
          src={item.image}
      ...
      <Inner>
        ...
        <Grid>
          {items.map((item) => {
            ...
            const isMobileAuction = item.title === "Auctions";

            return (
              <Card key={item.title} $mobileAuction={isMobileAuction}>
                <CardMediaContent item={item} Icon={Icon} Scene={Scene} />

                <CardBody $mobileAuction={isMobileAuction}>
                  <CardTitle $mobileAuction={isMobileAuction}>
                    {item.title}
                  </CardTitle>
                  <CardDescription $mobileAuction={isMobileAuction}>
                    {item.description}
                  </CardDescription>

                  <CountPill $mobileAuction={isMobileAuction}>
                    <CountIconWrap $mobileAuction={isMobileAuction}>
                      <UsersIcon />
                    </CountIconWrap>
                    <span>
                      <CountValue $mobileAuction={isMobileAuction}>
                        {value}
                      </CountValue>{" "}
                      <CountLabel $mobileAuction={isMobileAuction}>
                        {label}
                      </CountLabel>
                    </span>
                  </CountPill>
...
function DiamondBadgeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M8 6H16L20 10.5L12 19L4 10.5L8 6Z"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinejoin="round"
      />
...
function GavelBadgeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M8.2 9.3L11.8 5.8L18.2 12.2L14.7 15.8L8.2 9.3Z"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinejoin="round"
      />
...
function UsersIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M3.5 18.2C4.7 15.9 6.3 14.8 8.7 14.8C11.1 14.8 12.7 15.9 13.9 18.2"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinecap="round"
      />
      ...
      />
      <path
        d="M15 14.8C17 15 18.5 16 19.6 17.9"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinecap="round"
      />
...
function FlatsScene() {
  return (
    ...
    >
      ...
      <path
        d="M0 320C98 302 161 292 242 298C332 305 398 333 507 318C561 310 606 302 640 296V420H0V320Z"
        fill="#9BB26B"
      />
      <path
        d="M0 350C90 338 174 340 254 350C345 362 445 376 640 338V420H0V350Z"
        fill="#6F8F4B"
      />
      ...
      <defs>
        ...
        <radialGradient
          ...
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(83 84) rotate(90) scale(70)"
        >
...
function VillasScene() {
  return (
    ...
    >
      ...
      <path
        d="M0 318C138 282 268 278 404 300C485 313 548 330 640 340V420H0V318Z"
        fill="#557447"
      />
      ...
      <path
        d="M96 338C166 332 198 306 235 288C280 266 350 262 425 286C474 302 522 330 640 344V420H0V356C34 350 64 344 96 338Z"
        fill="#8D7A5C"
        opacity="0.45"
      />
...
function PlotsScene() {
  return (
    ...
    >
      ...
      <path
        d="M0 126C96 146 156 166 226 194C302 224 382 222 476 196C540 178 584 154 640 132V420H0V126Z"
        fill="#6E9240"
        opacity="0.42"
      />
      <defs>
...
function CommercialScene() {
  return (
    ...
    >
      ...
      <path
        d="M0 348C112 332 248 336 332 346C420 356 520 362 640 338V420H0V348Z"
        fill="#8393A2"
      />
...
function FarmlandsScene() {
  return (
    ...
    >
      ...
      <path
        d="M0 206C90 164 182 158 268 188C332 210 418 210 492 180C540 160 590 148 640 150V420H0V206Z"
        fill="#90AF56"
      />
      <path
        d="M0 268C124 230 240 234 320 264C388 290 470 294 640 238V420H0V268Z"
        fill="#73954B"
      />
      <path
        d="M0 318C116 292 202 298 282 322C378 352 484 360 640 316V420H0V318Z"
        fill="#55743E"
      />
      <path
        d="M46 328H202"
      ...
      />
      <path
        d="M396 248C420 214 452 192 488 188C512 186 536 198 546 220C556 244 544 278 512 300C474 326 424 336 384 320C350 306 334 274 346 246C358 222 376 208 396 200"
        fill="#6F8F45"
      />
      <path
        d="M404 248C420 236 434 218 438 198"
        stroke="#59753B"
        strokeWidth="5"
        strokeLinecap="round"
      />
      <defs>
        ...
        <radialGradient
          ...
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(118 98) rotate(90) scale(62)"
        >
...
function LuxuryScene() {
  return (
    ...
    >
      ...
      <path
        d="M0 332C102 318 176 300 238 282C316 260 402 258 498 286C556 302 600 320 640 336V420H0V332Z"
        fill="#5B7345"
      />
