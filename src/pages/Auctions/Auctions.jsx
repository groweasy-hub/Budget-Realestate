...
function Auctions() {
  ...
  useEffect(() => {
    ...
    const propertyTypeValue =
      propertyTypeFromQuery && search.propertyTypes.includes(propertyTypeFromQuery)
  ...
  const filteredListings = useMemo(() => {
    ...
    return listings.filter((listing) => {
      ...
      const toDateMatches =
        ...
        (listing.auctionDateValue && listing.auctionDateValue <= appliedFilters.toDate);
                    ...
                    >
                      <FilterLabelWrap>
                        <HiddenCheckbox
                          ...
                          readOnly
                        />
                        <CheckboxMark $checked={selectedStatuses.includes(item.label)} />
                        <span>{item.label}</span>
                      </FilterLabelWrap>
                      <FilterCount>({item.count})</FilterCount>
                    </FilterRow>
              ...
              <ResultsList>
                {filteredListings.map((listing) => (
                  ...
                  >
                    <ResultCardGrid>
                      <ResultFigure>
                        <ResultImage src={listing.image} alt={listing.imageAlt} />
                      ...
                      <ResultBody>
                        ...
                        <MetricsRow>
                          <MetricBlock>
                            ...
                            <MetricValue $accent>{listing.reservePrice}</MetricValue>
                          </MetricBlock>
                          <MetricBlock>
                          ...
                          <MetricBlock>
                            <MetricLabel>
                              {listing.countdownSeed ? "Auction Ends In" : "Auction Date"}
                            </MetricLabel>
                            {listing.countdownSeed ? (
                              <CountdownRow>
                                {getCountdownItems(countdownTargets[listing.id], now).map((item) => (
                                  <CountdownBox key={item.unit}>
                                    <CountdownValue>{item.value}</CountdownValue>
                                    <CountdownLabel>{item.unit}</CountdownLabel>
                                  </CountdownBox>
                                ))}
                              </CountdownRow>
                            ) : (
...
function ListIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M7.5 5.5H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M7.5 10H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M7.5 14.5H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
function BedIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2.5 8.5V12.2" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M13.5 8.5V12.2" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M2.5 9H13.5V11H2.5V9Z" stroke="currentColor" strokeWidth="1.4" />
      <path d="M4 6.2H7.2C8.08 6.2 8.8 6.92 8.8 7.8V9H4V6.2Z" stroke="currentColor" strokeWidth="1.4" />
      <path d="M8.8 6.8H11.2C12.08 6.8 12.8 7.52 12.8 8.4V9H8.8V6.8Z" stroke="currentColor" strokeWidth="1.4" />
    </svg>
  );
}
...
function AreaIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M6 3V5.4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M10 3V5.4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M3 6H5.4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M10.6 10H13" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
...
function ListingTypeIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 12.5V6.8L8 3.5L13 6.8V12.5" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
      <path d="M6.2 12.5V9.6H9.8V12.5" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
    </svg>
  );
}
...
function CalendarIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M6.5 2.8V6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M13.5 2.8V6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
...
function ShieldCheckIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 3.5L18 6V10.8C18 14.78 15.45 18.3 12 19.75C8.55 18.3 6 14.78 6 10.8V6L12 3.5Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M9.4 11.3L11.2 13.1L14.9 9.4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function DocumentBadgeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="5.5" y="4.5" width="10.5" height="14" rx="2" stroke="currentColor" strokeWidth="1.8" />
      <path d="M8.5 8H13.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M8.5 11H13.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <circle cx="17.5" cy="15.5" r="3" stroke="currentColor" strokeWidth="1.8" />
      <path d="M16.2 15.5L17.1 16.4L18.8 14.6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function OpportunityIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M4.8 18.3C4.8 15.83 6.63 14.1 9 14.1C11.37 14.1 13.2 15.83 13.2 18.3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M15.5 7.1V13.1" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M12.5 10.1H18.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
function HomeIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.8 9L10 4.5L16.2 9V15.5H12.2V11.8H7.8V15.5H3.8V9Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
...
function ApartmentIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="5.2" y="3.5" width="9.6" height="12.8" rx="1.5" stroke="currentColor" strokeWidth="1.5" />
      <path d="M8 6.3H8.01" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
      <path d="M12 6.3H12.01" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
      <path d="M8 9.6H8.01" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
      <path d="M12 9.6H12.01" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
      <path d="M9.2 16.3V12.9H10.8V16.3" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
...
function VillaIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.2 10L10 4.8L16.8 10V16H3.2V10Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M7.5 16V11.8H12.5V16" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M13.8 6.6V4.8H15.6V8" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
...
function PlotIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.5 14.5L7 5.5L14.5 8L12 17L4.5 14.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M7.8 6.4L12.8 9.6" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M6.6 10.6L11.6 13.8" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
}
...
function CommercialIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="4" width="12" height="12" rx="1.6" stroke="currentColor" strokeWidth="1.5" />
...
function IndustrialIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.5 16V8.5L8 10.8V7.2L12.5 9.5V6L16.5 8.4V16H3.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M6.2 13.2H6.21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M9.5 13.2H9.51" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M12.8 13.2H12.81" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
function ReviewIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="5.5" y="4.5" width="11" height="14" rx="2" stroke="currentColor" strokeWidth="1.8" />
      <path d="M8.5 8H13.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M8.5 11.5H13.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M16.5 16.5L19 19" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <circle cx="15.6" cy="15.6" r="3.2" stroke="currentColor" strokeWidth="1.8" />
    </svg>
  );
}
...
function AuctionBidIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M7 10.5L10 7.5L13 10.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10 7.5V15.2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M5.5 18.5H18.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M15.5 5.5H18.5V8.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18.5 5.5L14.8 9.2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
function CompleteIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12 4V2.8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
function BellIcon() {
  return (
    <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14 5.5C10.96 5.5 8.5 7.96 8.5 11V14.1C8.5 15.24 8.13 16.34 7.45 17.25L6 19.2H22L20.55 17.25C19.87 16.34 19.5 15.24 19.5 14.1V11C19.5 7.96 17.04 5.5 14 5.5Z" stroke="currentColor" strokeWidth="1.9" strokeLinejoin="round" />
      <path d="M11.8 21.2C12.2 22.26 13.02 22.8 14 22.8C14.98 22.8 15.8 22.26 16.2 21.2" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
      <circle cx="22.2" cy="19.3" r="2.2" stroke="currentColor" strokeWidth="1.7" />
      <path d="M24.8 21.8L26.3 23.3" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
...
function BankIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.5 9L12 5L19.5 9" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M6.5 10.5V17" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M10 10.5V17" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M14 10.5V17" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M17.5 10.5V17" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
...
function ValueIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="6" y="4.5" width="10" height="14" rx="2" stroke="currentColor" strokeWidth="1.8" />
      <path d="M9 8H13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M9 11.2H13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <circle cx="17.8" cy="15.5" r="3.2" stroke="currentColor" strokeWidth="1.8" />
    </svg>
  );
}
...
function UsersIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M4.8 18.2C4.8 15.4 7.03 13.5 10 13.5C12.97 13.5 15.2 15.4 15.2 18.2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M16.5 9.1C17.86 9.39 18.9 10.57 18.9 12.02C18.9 13.47 17.86 14.65 16.5 14.94" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
function ChatCheckIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6 17.5V19.5L9.2 17.5H17C18.38 17.5 19.5 16.38 19.5 15V7.5C19.5 6.12 18.38 5 17 5H7C5.62 5 4.5 6.12 4.5 7.5V15C4.5 16.38 5.62 17.5 7 17.5H6Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M8.5 11.3L10.4 13.2L14.8 8.8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function LockIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8.5 10V7.8C8.5 5.98 9.96 4.5 11.75 4.5H12.25C14.04 4.5 15.5 5.98 15.5 7.8V10" stroke="currentColor" strokeWidth="1.8" />
      <path d="M12 13.4V15.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
