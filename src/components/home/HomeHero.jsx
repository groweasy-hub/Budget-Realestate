...
import {
  ...
  MobileServicesTitleBlock,
  MobileServicesTitle,
  MobileServicesTitleBar,
  MobileServicesViewAll,
  MobileServicesGrid,
  MobileServiceItem,
  MobileServiceIconCircle,
  MobileServiceLabel,
...
const services = [
  ...
  {
    label: "Registration\nAssistance",
    href: "/services#registration-assistance",
...
function HomeHero({ activeTab = "buy" }) {
  ...
  const handleSearch = () => {
    ...
    navigate(
      searchQuery ? `${currentTab.href}?${searchQuery}` : currentTab.href,
    );
  };
  ...
  return (
    <HeroShell>
      ...
      <HeroContent>
        <HeroCopy>
          {/* House outline mark — top right of title */}
          <HeroMark>
            <HouseMarkIcon />
          </HeroMark>
          ...
          <HeroSubtitle>
            <SubtitleLine>
              Buy, Rent or Invest in the right property at the right price.
            </SubtitleLine>
            <SubtitleLine>
          ...
          {/* Tabs: Buy / Rent / Auctions / Services */}
          <HeroTabs>
            {tabs.map((tab) => {
              const Icon = tab.icon;
        ...
        <LeftBadge>
          ...
          <BadgeCopy>
            <BadgeHeading>
              Best Properties. Best Prices. Best Deals.
            </BadgeHeading>
            <BadgeText>
      ...
      {/* Mobile-only: Services strip below the main content */}
      <MobileServicesSection>
        <MobileServicesHeader>
          <MobileServicesTitleBlock>
            <MobileServicesTitle>Services</MobileServicesTitle>
            <MobileServicesTitleBar />
          </MobileServicesTitleBlock>
          <MobileServicesViewAll to="/services">
            View All
            <ChevronRightIcon />
          </MobileServicesViewAll>
        </MobileServicesHeader>
        ...
        <MobileServicesGrid>
          {services.map((service) => {
            ...
            return (
              <MobileServiceItem key={service.label} to={service.href}>
                <MobileServiceIconCircle>
                  <Icon />
                </MobileServiceIconCircle>
                <MobileServiceLabel>
...
function HomeTabIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M5 15.5L16 6L27 15.5V27H19.5V20H12.5V27H5V15.5Z"
        fill="currentColor"
      />
    </svg>
  );
...
function HeadsetTabIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M7 16C7 11.03 11.03 7 16 7C20.97 7 25 11.03 25 16"
        stroke="currentColor"
        strokeWidth="2.4"
      />
      <path
      ...
      />
      <path
        d="M21 25C21 27 19.3 28 16.7 28H16"
        stroke="currentColor"
        strokeWidth="2.4"
        strokeLinecap="round"
      />
...
function ClipboardEditIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M19 21L24.8 15.2L27 17.4L21.2 23.2L18.5 23.7L19 21Z"
        stroke="currentColor"
        strokeWidth="2.1"
        strokeLinejoin="round"
      />
...
function ScaleIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M12 10L8 17H16L12 10Z"
        stroke="currentColor"
        strokeWidth="2.1"
        strokeLinejoin="round"
      />
      <path
        d="M20 10L16 17H24L20 10Z"
        stroke="currentColor"
        strokeWidth="2.1"
        strokeLinejoin="round"
      />
...
function SearchHomeIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M7 14L16 7L25 14V24H18V18H14V24H7V14Z"
        stroke="currentColor"
        strokeWidth="2.1"
        strokeLinejoin="round"
      />
...
function HouseRupeeIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M6 14.5L16 7L26 14.5V25H6V14.5Z"
        stroke="currentColor"
        strokeWidth="2.1"
        strokeLinejoin="round"
      />
